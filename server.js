...
const API_KEY = process.env.d56d4c0cf57382ee57ddd97b4c2e9c8a;
...
function generateFakeForecast(location) {
    location = location || '18.5768691,73.7272513';
...
function getForecast(req, resp) {
    const location = req.params.location || '18.5768691,73.7272513';
